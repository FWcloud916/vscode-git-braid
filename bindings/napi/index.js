...
if (!nativeAddon) {
  ...
  nativeAddon = { discoverRepo: notBuilt, getGraphBatch: notBuilt, getCommitDetail: notBuilt, getBlob: notBuilt, findCommits: notBuilt, listRefs: notBuilt, walkRange: notBuilt };
}
